...
#  Copyright 2014-2016 condres <devs@condres.com>
#  Copyright 2015 Martin Wimpress <code@flexion.org>
#
#  condres-welcome is free software: you can redistribute it and/or modify
#  it under the temms of the GNU General Public License as published by
#  the Free Software Foundation, either version 3 of the License, or
#  (at your option) any later version.
#
#  condres-welcome is distributed in the hope that it will be useful,
#  but WITHOUT ANY WARRANTY; without even the implied warranty of
#  MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
#  GNU General Public License for more details.
#
#  You should have received a copy of the GNU General Public License
#  along with condres-welcome. If not, see <http://www.gnu.org/licenses/>.

""" Welcome screen for condres """
...
class WelcomeConfig(object):
    ...
    def __init__(self):
        ...
        self._config_dir = os.path.expanduser('~/.config/condres/welcome/')

        # store full path to our autostart symlink
        self._autostart_path = os.path.expanduser('~/.config/autostart/condres-welcome.desktop')
    ...
    def autostart(self, state):
        if state and not os.path.exists(self._autostart_path):
            ...
            try:
                os.symlink(
                    '/usr/share/applications/condres-welcome.desktop',
...
class WelcomeApp(Gtk.Application):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, application_id="com.condres.welcome",
    ...
    def do_activate(self):
        ...
        if not self.window:
            ...
            self.window = WelcomeWindow(application=self, title="condres Welcome")
...
class WelcomeWindow(Gtk.ApplicationWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.set_name('condres-welcome')
        self.set_title('')
        self.set_geometry(768, 496)

        icon_dir = os.path.join(self._data_path, 'img/logos', 'condres.png')
    ...
    def set_data_path(self):
        ...
        elif os.path.exists('/usr/share/condres/welcome/data'):
            print('Using /usr/share/condres/welcome/data path.')
            self._data_path = '/usr/share/condres/welcome/data'
        else:
            print('Unable to source the condres-welcome data directory.')
            sys.exit(1)
