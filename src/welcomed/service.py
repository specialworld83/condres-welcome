...
#  service.py
#
#  Copyright © 2015-2017 condres
#
#  This file is part of condres-welcome
#
...
INTERFACE = 'com.condres.welcome'


class DBusService(object):
    """
    <node>
        <interface name='com.condres.welcome'>
    ...
    def __init__(self, mainloop, object_path="/com/condres/welcome"):
        self.alpm = None
...
#            self.command_queue.put((uid, 'refresh', []))
    ...
    def command_finished(self, value):
        ...
        # print(value)
        self.PropertiesChanged("com.condres.welcome", {"command_finished": self.command_finished}, [])
    ...
    def is_authorized(self, dbus_context, interactive=True):
        action_id = "com.condres.welcome.install"
        details = {
            'polkit.icon': 'condres-welcome',
            'polkit.message': 'condres-welcome'}
